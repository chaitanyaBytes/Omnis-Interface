        ...
        <div className="space-y-4">
          <div className="space-y-1">
            ...
            <p className="text-[#717BBC] text-sm">
              Based on your medium risk profile and $
              {portfolioSummary.totalCapital} investment
            </p>
          </div>
            ...
            <div key={s.id}>
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="text-[#293056] text-sm">
                    Est. APY: {s.estimatedAPY}%
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-[#F4F7FF] px-4 py-3 rounded-2xl space-y-1">
            <div className="flex justify-between items-center">
              ...
              <p className="text-[#039855] font-medium text-md">
                ~{formatNumber(portfolioSummary.expectedMonthlyReturn)} USD
              </p>
            </div>
            ...
            <div className="flex justify-between items-center">
              ...
              <p className="font-medium text-md">
                {formatNumber(portfolioSummary.totalCapital)} USD
              </p>
            </div>
          </div>
          ...
          <div className="space-y-1">
            <Button
              disabled
              onClick={onDeploy}
              className="bg-[#363F72] w-full rounded-3xl hover:bg-[#363F72]/90 cursor-pointer"
            >
              Deploy Portfolio
            </Button>
            <Link
              href="https://omnis-labs.gitbook.io/v1"
              target="_blank"
              rel="noopener noreferrer"
              className="text-sm text-[#717BBC] underline"
            >
